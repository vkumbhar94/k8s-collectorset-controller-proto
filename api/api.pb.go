...
type CollectorIDReply struct {
	...
	CscVersion string `protobuf:"bytes,2,opt,name=cscVersion,proto3" json:"cscVersion,omitempty"`
}
...
func (x *CollectorIDReply) GetCscVersion() string {
	if x != nil {
		return x.CscVersion
	}
	return ""
...
var file_api_proto_rawDesc = []byte{
	...
	0x63, 0x68, 0x65, 0x73, 0x74, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x22, 0x42, 0x0a, 0x10, 0x43, 0x6f,
	...
	,
}
...
var file_api_proto_depIdxs = []int32{
	...
	0, // 1: api.CollectorSetController.CollectorSetControllerVersion:input_type -> api.CollectorIDRequest
	1, // 2: api.CollectorSetController.CollectorID:output_type -> api.CollectorIDReply
	1, // 3: api.CollectorSetController.CollectorSetControllerVersion:output_type -> api.CollectorIDReply
...
type CollectorSetControllerClient interface {
	...
	CollectorSetControllerVersion(ctx context.Context, in *CollectorIDRequest, opts ...grpc.CallOption) (*CollectorIDReply, error)
}
...
func (c *collectorSetControllerClient) CollectorSetControllerVersion(ctx context.Context, in *CollectorIDRequest, opts ...grpc.CallOption) (*CollectorIDReply, error) {
	out := new(CollectorIDReply)
	err := c.cc.Invoke(ctx, "/api.CollectorSetController/CollectorSetControllerVersion", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CollectorSetControllerServer interface {
	...
	CollectorSetControllerVersion(context.Context, *CollectorIDRequest) (*CollectorIDReply, error)
}
...
func (*UnimplementedCollectorSetControllerServer) CollectorSetControllerVersion(context.Context, *CollectorIDRequest) (*CollectorIDReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CollectorSetControllerVersion not implemented")
}
...
func _CollectorSetController_CollectorSetControllerVersion_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CollectorIDRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CollectorSetControllerServer).CollectorSetControllerVersion(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.CollectorSetController/CollectorSetControllerVersion",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CollectorSetControllerServer).CollectorSetControllerVersion(ctx, req.(*CollectorIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _CollectorSetController_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CollectorSetControllerVersion",
			Handler:    _CollectorSetController_CollectorSetControllerVersion_Handler,
		},
	},
